...
type ViewMode = 'home' | 'admin' | 'login';
...
export default function App() {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      image: 'https://images-eds-ssl.xboxlive.com/image?url=4rt9.lXDC4H_93laV1_eHHFT949fUipzkiFOBH3fAiZZUCdYojwUyX2aTonS1aIwMrx6NUIsHfUHSLzjGJFxxhfRM_njI7Pu32CmBLMdmnnzF6MdNHw4MJwlr.tSWLA2EJBQdZh0p3nNDzGvX2F6NoIc9ZSQ9xJqsGEg5bouOnA-&format=source&h=210',
    },
    {
      name: 'Amit Verma',
      location: 'Noida',
      ...
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUaxSN36_mo1kbJSLdaM8w7UMISwyczCi96Q&s',
    },
    {
      name: 'Sunita Devi',
      location: 'Faridabad',
  ...
  const popularRoutes = [
    { from: 'Delhi', to: 'Jaipur', distance: '280 km' },
    { from: 'Delhi', to: 'Agra', distance: '230 km' },
    { from: 'Delhi', to: 'Haridwar', distance: '220 km'},
    { from: 'Delhi', to: 'Rishikesh', distance: '240 km' },
    { from: 'Delhi', to: 'Mathura', distance: '160 km'},
    { from: 'Delhi', to: 'Dehradun', distance: '250 km'},
  ];
  ...
  useEffect(() => {
    ...
    const { data: { subscription } } = supabase.auth.onAuthStateChange((_event, session) => {
      if (session?.user) {
        const isAdmin = session.user.email === 'ansh6631@pandeycab.in';
        if (isAdmin) {
        ...
        setAdminAuth({ isAuthenticated: false, loading: false, user: null, error: '' });
      }
    });
 ...
 useEffect(() => {
  if (viewMode === 'admin' && adminAuth.isAuthenticated) {
    fetchInquiries();
  }
}, [viewMode, adminAuth.isAuthenticated]);
 ...
 useEffect(() => {
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    e.preventDefault();
    setAdminAuth({ ...adminAuth, loading: true, error: '' });
    ...
    if (data.user) {
      ...
      setAdminAuth({ isAuthenticated: true, loading: false, user: data.user, error: '' });
      setViewMode('admin');
  ...
  const updateLeadStatus = async (inquiryId: string, newStatus: LeadStatus) => {
            ...
            <form onSubmit={handleAdminLogin} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="admin@pandeycabs.com"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-primary-600 hover:bg-primary-700 disabled:bg-primary-300 text-white font-bold py-3 px-6 rounded-xl transition shadow-lg"
              >
            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="bg-red-50 hover:bg-red-100 text-red-700 px-4 py-2 rounded-lg transition flex items-center space-x-2"
                >
          ...
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex items-center gap-5">
              <span className="flex items-center gap-2">
                ...
                <span className="font-bold">4.4/5 Rating</span>
              </span>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-200 hover:border-brand-300 transition">
                  <div className="text-3xl font-black text-slate-900 mb-1">4.4</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              <div className="relative h-56 overflow-hidden">
                <img
                  src="https://images.pexels.com/photos/13832305/pexels-photo-13832305.jpeg"
            ...
            <div className="bg-white rounded-2xl border-2 border-orange-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group relative">
              ...
              <div className="relative h-56 overflow-hidden">
                <img
                  src="https://saishishirtours.in/wp-content/uploads/2022/12/char-dham-blog-banner-scaled.webp"
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              <div className="relative h-56 overflow-hidden">
                <img
                  src="https://goantaxi.in/images/outstation-cab.jpg"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-primary-300 hover:shadow-xl transition-all group">
              <div className="relative h-36 overflow-hidden bg-gray-100">
                <img
                  src="https://images.jdmagicbox.com/quickquotes/images_main/maruti-suzuki-swift-dzire-tour-s-bs6-pearl-metallic-arctic-white-271052469-42tlj.png"
                  alt="Maruti Dzire"
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-primary-300 hover:shadow-xl transition-all group">
              <div className="relative h-36 overflow-hidden bg-gray-100">
                <img
                  src="https://stimg.cardekho.com/images/carexteriorimages/630x420/Maruti/Ertiga-Tour/9617/1762858404297/front-left-side-47.jpg"
                  alt="Maruti Ertiga"
                  className="w-full h-full object-cover group-hover:scale-110 transition duration-500"
                />
                <div className="absolute top-2 right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-orange-300 hover:shadow-xl transition-all group">
              <div className="relative h-36 overflow-hidden bg-gray-100">
                <img
                  src="https://imgd.aeplcdn.com/1200x900/n/cw/ec/140809/innova-crysta-exterior-right-front-three-quarter-3.png?isig=0&q=80"
                  alt="Toyota Innova"
                  className="w-full h-full object-cover group-hover:scale-110 transition duration-500"
                />
                <div className="absolute top-2 right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-primary-300 hover:shadow-xl transition-all group">
              <div className="relative h-36 overflow-hidden bg-gray-100">
                <img
                  src="https://cdn-s3.autocarindia.com/legacy/cdni/ExtraImages/20111003110855_Toyota-Etios-Diesel-4.jpg"
                  alt="Toyota Fortuner"
                  className="w-full h-full object-cover group-hover:scale-110 transition duration-500"
                />
                <div className="absolute top-2 right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">
              ...
              <div className="p-4 text-center">
                <h4 className="font-bold text-gray-900 mb-1">Toyota Etios</h4>
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-primary-300 hover:shadow-xl transition-all group">
              <div className="relative h-36 overflow-hidden bg-gray-100">
                <img
                  src="https://cdn.bluebirdtravels.in/wp-content/uploads/2017/01/Tempo_Traveller_PI-531x354.png"
                  alt="Tempo Traveller"
                  className="w-full h-full object-cover group-hover:scale-110 transition duration-500"
                />
                <div className="absolute top-2 right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">
